...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BgXWI5QJ.mjs");
...
//#endregion
export { createServerEntry, server_default as default, server_exports as t };
