...
import { I as redirect, _ as createRootRoute, g as createFileRoute, h as lazyRouteComponent, l as Scripts, m as Outlet, p as createRouter, u as HeadContent, y as useRouter } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { $t as initGetModelName, A as decodeProtectedHeader, At as looseObject, C as toResponse, Dt as boolean, E as filterOutputFields, Et as array, Ft as string, Gt as import_src, Ht as ATTR_CONTEXT, It as union, Jt as getCurrentAdapter, Kt as safeJSONParse, Mt as object, Nt as optional, O as base64Url, Ot as email, Pt as record, Qt as getBetterAuthVersion, S as createRouter$1, T as serializeSignedCookie, Tt as any, Ut as ATTR_HOOK_TYPE, Vt as withSpan, Wt as ATTR_OPERATION_ID, Xt as runWithAdapter, Yt as queueAfterTransactionHook, Zt as runWithTransaction, _ as defineRequestState, _n as defineErrorCodes, a as betterFetch, an as shouldPublishLog, b as getCurrentAuthContext, c as isLoopbackHost, d as getIp, dn as isProduction, en as initGetFieldName, et as encode, f as deprecate, fn as isTest, ft as JWTExpired, g as isAPIError, gn as BASE_ERROR_CODES, h as createAuthMiddleware, hn as kAPIErrorHeaderSymbol, i as refreshAccessToken, in as logger, j as jwtVerify, jt as number, k as decodeJwt, kt as literal, l as createRateLimitKey, m as createAuthEndpoint, mn as BetterAuthError, n as socialProviders, nn as createRandomStringGenerator, o as createAuthorizationURL, p as normalizePathname, pn as APIError, qt as getAuthTables, r as validateAuthorizationCode, rn as createLogger, s as applyDefaultAccessTokenExpiry, sn as env, t as SocialProviderListEnum, tn as generateId, u as findInvalidTrustedProxies, un as isDevelopment, v as hasRequestState, w as serializeCookie, x as runWithEndpointContext, y as runWithRequestState } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BnseNEMo.js
...
var styles_default = "/assets/styles-CFOV5_z8.css";
var APP_NAME = "Lumen — HEIC Converter";
var Route$10 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Convert HEIC and HEIF photos to JPEG, PNG, or WebP. Runs entirely in your browser — nothing is uploaded."
			},
			{
...
var $$splitComponentImporter$7 = () => import("./routes--h0FA_4D.mjs");
var Route$9 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./about-hdBhmZvc.mjs");
var Route$8 = createFileRoute("/about")({
	head: () => ({ meta: [{ title: "Learn — Lumen" }, {
		name: "description",
		content: "A plain-language guide to HEIC photos: what they are, who made them, why iPhones use them, and when to convert."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
var $$splitComponentImporter$5 = () => import("./compression-BrutEu7G.mjs");
var Route$7 = createFileRoute("/compression")({
	head: () => ({ meta: [{ title: "HEIC file size — Lumen" }, {
		name: "description",
		content: "See how much smaller a HEIC photo is than JPEG, WebP, or PNG — with a live comparison."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
var $$splitComponentImporter$4 = () => import("./how-24aIfpoI.mjs");
var Route$6 = createFileRoute("/how")({
	head: () => ({ meta: [{ title: "How HEIC compresses — Lumen" }, {
		name: "description",
		content: "A plain-language look at how HEIC / HEVC shrinks a photo: adaptive tiles, guessing from neighbors, and packing the leftovers."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./insurance-x1PZKawW.mjs");
var Route$5 = createFileRoute("/insurance")({
	head: () => ({ meta: [
		{ title: "Digital liability insurance — Lumen" },
		{
			name: "robots",
			content: "noindex"
		},
		{
			name: "description",
			content: "A plain-language map of tech E&O, cyber, and media liability for a published web tool. Not insurance advice."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
var $$splitComponentImporter$2 = () => import("./jpeg-artifacts-LFsM_4it.mjs");
var Route$4 = createFileRoute("/jpeg-artifacts")({
	head: () => ({ meta: [{ title: "JPEG artifacts — Lumen" }, {
		name: "description",
		content: "A plain-language guide to JPEG artifacts: blocking, banding, mosquito noise, and why they do not go away."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var Route$3 = createFileRoute("/login")({ beforeLoad: () => {
	throw redirect({ to: "/" });
} });
var $$splitComponentImporter$1 = () => import("./privacy-ChMwwggl.mjs");
var Route$2 = createFileRoute("/privacy")({
	head: () => ({ meta: [{ title: "Privacy Notice — Lumen" }, {
		name: "description",
		content: "Lumen converts HEIC files in your browser. Photos are not uploaded for conversion. Read how technical and account data is handled."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./terms-CDDklKZl.mjs");
var Route$1 = createFileRoute("/terms")({
	head: () => ({ meta: [{ title: "Terms of Use — Lumen" }, {
		name: "description",
		content: "Terms of Use for the Lumen HEIC converter. The tool is provided as-is. Conversion runs on your device."
	}] }),
...
var rootRouteChildren = {
	...
	CompressionRoute: Route$7.update({
		id: "/compression",
		path: "/compression",
		getParentRoute: () => Route$10
	}),
	HowRoute: Route$6.update({
		id: "/how",
		path: "/how",
		getParentRoute: () => Route$10
	}),
	InsuranceRoute: Route$5.update({
		id: "/insurance",
		path: "/insurance",
		getParentRoute: () => Route$10
	}),
	JpegArtifactsRoute: Route$4.update({
		id: "/jpeg-artifacts",
		path: "/jpeg-artifacts",
		getParentRoute: () => Route$10
	}),
