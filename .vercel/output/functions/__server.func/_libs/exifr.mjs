import { i as __require, r as __exportAll } from "../_runtime.mjs";
//#region node_modules/exifr/dist/full.esm.mjs
var full_esm_exports = /* @__PURE__ */ __exportAll({
	Exifr: () => te,
	Options: () => q,
	allFormatters: () => X,
	chunkedProps: () => G,
...
var C = (e) => String.fromCharCode.apply(null, e);
...
var M = (e) => h(e).then(((e) => e.arrayBuffer()));
var R = (e) => new Promise(((t, i) => {
...
var $e = (e) => 1 === e.length ? e[0] : e;
var Je = (e, t) => t[e] ? t[e] : t[e] = {};
function qe(e, t) {
	let i, n = [];
	if (!e) return n;
